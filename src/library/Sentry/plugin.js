 ...
 */
function ReactNativeRavenPlugin(Raven, options, internalDataCallback) {
  options = options || {};

  // Use data callback to strip device-specific paths from stack traces
  Raven.setDataCallback(
    wrappedCallback(function (data) {
      data = ReactNativeRavenPlugin._normalizeData(data, options.pathStrip);
  ...
  if (options.nativeClientAvailable === false) {
    ...
    Raven.setTransport(ReactNativeRavenPlugin._transport);
    ...
    Raven.setShouldSendCallback(function (data, originalCallback) {
      ...
      ReactNativeRavenPlugin._persistPayload(data).then(function () {
 ...
 */
ReactNativeRavenPlugin._persistPayload = function (payload) {
  var AsyncStorage = require("react-native").AsyncStorage;
  return AsyncStorage.setItem(ASYNC_STORAGE_KEY, JSON.stringify(payload)).catch(function () {
    return null;
  });
};
 ...
 * Returns a promise that guarantees never to reject.
 */
ReactNativeRavenPlugin._restorePayload = function () {
  var AsyncStorage = require("react-native").AsyncStorage;
 ...
 */
ReactNativeRavenPlugin._clearPayload = function () {
  var AsyncStorage = require("react-native").AsyncStorage;
 ...
 */
ReactNativeRavenPlugin._transport = function (options) {
 ...
 */
ReactNativeRavenPlugin._normalizeData = function (data, pathStripRe) {
...
module.exports = ReactNativeRavenPlugin;
