 ...
 *
 * ref https://github.com/Yenole/react-native-easy-loading
 *
 * [fix] proptypes error
 */
    ...
    return (
      <Modal
        ...
        <View style={[styles.load_box, this.props.loadingStyle]}>
          <ActivityIndicator animating={true} color={this.props.color || "grey"} size={"large"} style={styles.load_progress} />
